  ...
  initPluginColumns() {
    this.setState({
      columns: [
        {
          align: "center",
          title: getIntlContent("SHENYU.MENU.SERVICE.MANAGEMENT.NAME"),
          dataIndex: "name",
          key: "name",
          ellipsis: true,
          width: 120,
        ...
        {
          align: "center",
          title: getIntlContent("SHENYU.MENU.SERVICE.MANAGEMENT.PLUGIN"),
          dataIndex: "role",
          ellipsis: true,
          key: "role",
          width: 120,
        ...
        {
          align: "center",
          title: getIntlContent("SHENYU.MENU.SERVICE.MANAGEMENT.CONDITION"),
          dataIndex: "sort",
          ellipsis: true,
          key: "sort",
          // width: 120,
        ...
        {
          align: "center",
          title: getIntlContent("SHENYU.MENU.SERVICE.MANAGEMENT.HANDLER"),
          dataIndex: "config",
          key: "config",
          ellipsis: true,
          render: (text, record) => {
